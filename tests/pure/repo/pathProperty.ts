...
Deno.test(decodeName, (): void => {
  assertProperty(
    defineReplayTarget("tests/pure/repo/pathProperty.ts", decodeName),
    fc.property(
...
Deno.test(nfcName, (): void => {
  assertProperty(
    defineReplayTarget("tests/pure/repo/pathProperty.ts", nfcName),
    fc.property(
...
Deno.test(collisionName, (): void => {
  assertProperty(
    defineReplayTarget("tests/pure/repo/pathProperty.ts", collisionName),
