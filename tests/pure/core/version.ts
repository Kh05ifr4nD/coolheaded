...
Deno.test(validName, (): void => {
  assertProperty(
    defineReplayTarget("tests/pure/core/version.ts", validName),
...
Deno.test(symmetryName, (): void => {
  assertProperty(
    defineReplayTarget("tests/pure/core/version.ts", symmetryName),
...
Deno.test(transitiveName, (): void => {
  assertProperty(
    defineReplayTarget("tests/pure/core/version.ts", transitiveName),
    fc.property(
      fullVersion,
      fullVersion,
      fullVersion,
...
Deno.test(buildName, (): void => {
  assertProperty(
    defineReplayTarget("tests/pure/core/version.ts", buildName),
    fc.property(
      precedenceVersion,
      buildMetadata,
      buildMetadata,
...
Deno.test(formatName, (): void => {
  assertProperty(
    defineReplayTarget("tests/pure/core/version.ts", formatName),
...
Deno.test(prereleaseName, (): void => {
  assertProperty(
    defineReplayTarget("tests/pure/core/version.ts", prereleaseName),
    fc.property(
      coreVersion,
