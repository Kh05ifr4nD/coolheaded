...
function releaseAssetUrls(version: string): Readonly<Record<SupportedSystem, string>> {
  return {
    "aarch64-darwin": releaseAssetUrl(version, CUE_RELEASE_TARGETS["aarch64-darwin"]),
    "aarch64-linux": releaseAssetUrl(version, CUE_RELEASE_TARGETS["aarch64-linux"]),
    "x86_64-linux": releaseAssetUrl(version, CUE_RELEASE_TARGETS["x86_64-linux"]),
  };
}
