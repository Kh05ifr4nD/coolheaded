...
function assetUrls(version: string): Readonly<Record<string, string>> {
  const baseUrl = `https://github.com/colbymchenry/codegraph/releases/download/v${version}`;
...
function updateProgram(
  ...
  return updateNewerPinVersion(
    ...
    (): Effect.Effect<string, GitHubVersionError> =>
      latestGitHubVersion({ owner: "colbymchenry", repo: "codegraph" }, dependencies.jsonClient),
